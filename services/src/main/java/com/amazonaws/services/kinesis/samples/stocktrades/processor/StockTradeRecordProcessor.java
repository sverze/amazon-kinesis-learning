...
public class StockTradeRecordProcessor implements IRecordProcessor {
    ...
    public StockTradeRecordProcessor(long delay) {
        this.delay = delay;
    }
    /**
     * {@inheritDoc}
    ...
    private void processRecord(Record record) {
        ...
        stockStats.addStockTrade(trade, record.getApproximateArrivalTimestamp());
    }
    ...
    private void checkpoint(IRecordProcessorCheckpointer checkpointer) {
        ...
        // Checkpointing stores the progress in dynamoDB. This means that on start up the processor will pick up where it left off.
        // In cases where you actually want to reprocess the entire stream you should not checkpoint at all and set
