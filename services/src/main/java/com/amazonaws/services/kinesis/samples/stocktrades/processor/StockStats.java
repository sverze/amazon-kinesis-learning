...
public class StockStats {
     ...
     */
    public void addStockTrade(StockTrade trade, Date arrivalTime) {
        ...
        if (earliestOrder == null || arrivalTime.before(earliestOrder)) {
            earliestOrder = arrivalTime;
        }
        if (latestOrder == null || arrivalTime.after(latestOrder)) {
            latestOrder = arrivalTime;
        }
    }

    public String toString() {
        String earliestOrder = this.earliestOrder != null ? this.earliestOrder.toString() : "N/A";
        String latestOrder = this.latestOrder!= null ? this.latestOrder.toString() : "N/A";
        return String.format(
                "Most popular stock being bought: %s, %d buys.%n" +
                "Most popular stock being sold: %s, %d sells.%n" +
                "Largest sell order: %d shares of %s.%n" +
                "Earliest order: %s, Latest order: %s.",
